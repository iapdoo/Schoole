...
class AddParent extends Component
{
    ...
    public $currentStep = 1,
        //Father Inputs
        $Email, $Password, $Name_Father, $Name_Father_en, $Job_Father, $Job_Father_en,
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:14|max:15|regex:/[0-9]{9}/',
            'Passport_ID_Father' => 'min:14|max:15',
            'Phone_Father' => 'regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
            'National_ID_Mother' => 'required|string|min:14|max:15|regex:/[0-9]{9}/',
            'Passport_ID_Mother' => 'min:14|max:15',
    ...
    public function submitForm()
    {
        try {
            ...
            $this->successMessage = trans('massage.do_success');
            $this->clearForm();
            $this->currentStep = 1;
...
//        $deleteImage = Str::after($My_Parent->photos, 'parent_attachments/');
//        $deleteImage = storage_path('app/parent_attachments/' . $deleteImage);
